...
public class Application3 { /* 실행 테스트용 */
    ...
    public static void main(String[] args) {
        ...
        do{
            System.out.println("===== 유기견 게시판 관리 =====");
            /* 조회 */   //System.out.println("조회");

            /* 추가 */
            System.out.println("1. 유기견 게시판 추가");

            /* 수정 */    //System.out.println("수정");

            /* 삭제 */
            System.out.println("2. 유기견 게시판 삭제");
            ...
            switch (no){
                ...
                /* 추가 */
                case 1: dogBoardController.registDogBoard(inputDogBoard()); break;

                /* 수정 */

                /* 삭제 */
                case 2: dogBoardController.deleteDogBoard(inputDogBoardCode()); break;
